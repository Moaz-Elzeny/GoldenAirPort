...
{
    public class PackageRegistrationConfiguration : IEntityTypeConfiguration<PackageRegistration>
    {
        public void Configure(EntityTypeBuilder<PackageRegistration> builder)
        {
            builder.ToTable("PackageRegistrations");
