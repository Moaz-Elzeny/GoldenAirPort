...
{
    public class TripRegistrationEditingConfiguration : IEntityTypeConfiguration<TripRegistrationEditing>
    {
        public void Configure(EntityTypeBuilder<TripRegistrationEditing> builder)
        {
            builder.ToTable("TripRegistrationsEditing");
